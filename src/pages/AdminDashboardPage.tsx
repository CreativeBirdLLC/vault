            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.recentLogins}</dd>
                </dl>
              </div>
            </div>
          </div>
                  ...
                  <div key={log.id} className="flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-sm text-gray-900">
                        <span className="font-medium">{log.action.replace('_', ' ')}</span> on {log.resource}
                      </p>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  Remember to regularly review audit logs and user permissions. 
                  Consider enabling MFA for all admin accounts.
                </p>
              </div>
            </div>
          </div>
